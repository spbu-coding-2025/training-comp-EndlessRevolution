# 0 "/home/user/training-comp-EndlessRevolution/src/main.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/user/training-comp-EndlessRevolution/src/main.c"
...
# 2 "/home/user/training-comp-EndlessRevolution/src/main.c" 2
...
# 3 "/home/user/training-comp-EndlessRevolution/src/main.c" 2
...
# 4 "/home/user/training-comp-EndlessRevolution/src/main.c" 2
...
# 10 "/home/user/training-comp-EndlessRevolution/src/main.c"
struct interval_t {
 double left_border;
 double right_border;
};
...
char **calculate_integrals(struct interval_t interval, unsigned int count, const unsigned int *partition_sizes) {
 ...
 if (!results) {
  return 
# 40 "/home/user/training-comp-EndlessRevolution/src/main.c" 3 4
        ((void *)0)
# 40 "/home/user/training-comp-EndlessRevolution/src/main.c"
            ;
 }
 ...
 for (unsigned int i = 0; i < count; ++i) {
  ...
  if (!results[i]) {
   ...
   (fprintf(
# 50 "/home/user/training-comp-EndlessRevolution/src/main.c" 3 4
  stderr
# 50 "/home/user/training-comp-EndlessRevolution/src/main.c"
  , "Cannot allocate memory for result string in %d experiment\n", i));
   return 
# 51 "/home/user/training-comp-EndlessRevolution/src/main.c" 3 4
         ((void *)0)
# 51 "/home/user/training-comp-EndlessRevolution/src/main.c"
             ;
  }
  ...
  if (!sprintf(results[i], "%d %.5f %.5f", partition_sizes[i], integral_rectangle, integral_simpson)) {
   ...
   (fprintf(
# 56 "/home/user/training-comp-EndlessRevolution/src/main.c" 3 4
  stderr
# 56 "/home/user/training-comp-EndlessRevolution/src/main.c"
  , "Cannot write results to string in %d experiment\n", i));
   return 
# 57 "/home/user/training-comp-EndlessRevolution/src/main.c" 3 4
         ((void *)0)
# 57 "/home/user/training-comp-EndlessRevolution/src/main.c"
             ;
  }
 }
...
# 72 "/home/user/training-comp-EndlessRevolution/src/main.c" 3 4
                                   3.14159265358979323846
# 72 "/home/user/training-comp-EndlessRevolution/src/main.c"
                                       };
 ...
 for (unsigned int i = 0; i < experiments_count; ++i) {
  if (printf("%s\n", results[i]) < 0) {
   (fprintf(
# 81 "/home/user/training-comp-EndlessRevolution/src/main.c" 3 4
  stderr
# 81 "/home/user/training-comp-EndlessRevolution/src/main.c"
